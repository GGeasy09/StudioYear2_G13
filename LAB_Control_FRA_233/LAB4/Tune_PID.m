...
J  = 0.8577e-1;           % Rotor inertia (.J = 0.107E-01f)
L  = 0.0002893301219;    % Motor inductance (.L = 0.0002893301219f)
R  = 0.4821323156;       % Motor resistance (.R = 0.4821323156f)
B  = 0.43085;              % Viscous friction coefficient (.B = 0.995f)
Kt = 2.2461;         % Torque constant (.kt = 0.20906532f)
Km = 2.2461;             % Back EMF constant (.km = 0.2316f)
