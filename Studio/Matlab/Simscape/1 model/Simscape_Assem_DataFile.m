...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [1.5347723092418164e-12 53.174999999999919 -513.45000000000095];  % mm
smiData.RigidTransform(2).angle = 2.0943951023931953;  % rad
smiData.RigidTransform(2).axis = [0.57735026918962562 -0.57735026918962551 0.57735026918962606];
smiData.RigidTransform(2).ID = "F[Assem_Body-1:-:Assem_Arm-1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(3).translation = [-44.574336449746106 -31.58535505829002 55.8500577615712];  % mm
smiData.RigidTransform(3).angle = 0;  % rad
smiData.RigidTransform(3).axis = [0 0 0];
smiData.RigidTransform(3).ID = "RootGround[Assem_Body-1]";
...
smiData.RevoluteJoint(1).Rz.Pos = 61.319038223187874;  % deg
